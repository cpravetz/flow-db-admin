...
Template.registerHelper 'admin_omit_fields', ->
	...
	if not Session.equals('admin_collection_name','Users') and typeof AdminConfig != 'undefined' and AdminConfig.collections[Session.get 'admin_collection_name'] and typeof AdminConfig.collections[Session.get 'admin_collection_name'].omitFields == 'object'
